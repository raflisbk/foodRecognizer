...
void main() {
  group('ImageClassificationService Tests', () {
    ...
    test('initialize - should initialize successfully with local model', () async {
      // Arrange & Act
    ...
    test('classifyImage - should handle image processing errors gracefully', () async {
      // Arrange
      await service.initialize();
    ...
    test('classifyImage - should return FoodPrediction with valid data', () async {
      // Arrange
      await service.initialize();
